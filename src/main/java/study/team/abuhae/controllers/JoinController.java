...
public class JoinController {
	...
	// 회원가입 최종 OK
	@RequestMapping(value = "join/parent/add_ok.do", method = RequestMethod.POST)
	public ModelAndView m_join_success(Model model, 
			@RequestParam(value = "type") char type,
			@RequestParam(value = "want_act") String want_act, 
			@RequestParam(value = "want_age") String want_age,
			@RequestParam(value = "kids_num") int kids_num, 
		...
		return new ModelAndView("/join/parent/success");
	}
}
