...
<html lang="ko">
	<head>
        ...
        <link rel="stylesheet" type="text/css" href="/ezen-android2020-2/customer/css/notice_site_ch2.css" />
		...
		<div class="container">
			...
			<div id="menu"></div> <!-- 헤더영역 load함수 -->
                <div class="col-xs-12 nav">
                    ...
                    <span>></span>
                    <li>
                        <a href="/ezen-android2020-2/customer/notice_site.html">공지사항</a>
                    </li>
                    <span>></span>
                    <li>
                        <a href="#">공지 사항</a>
