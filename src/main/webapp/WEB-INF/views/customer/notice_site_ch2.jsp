...
<html lang="ko">
	<head>
        ...
        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/assets/css/notice_site_ch2_yj.css" />
		...
		<div class="container">
			...
			<!-- header end-->
                <div class="col-xs-12 nav">
                    ...
                    <span>></span>
                    <li>
                        <a href="${pageContext.request.contextPath}/customer/notice_site.html">공지사항</a>
                    </li>
                    <span>></span>
                    <li>
                        <a href="#">공지 사항</a>
