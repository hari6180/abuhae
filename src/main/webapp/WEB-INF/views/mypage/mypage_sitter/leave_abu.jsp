                        ...
                        <div class="row">
                            <div class="col-md-6 col-xs-12" style="float: none; margin: 0 auto;">
                                ...
                                <div class="check_leave_cont">
                                    <ul>
                                        <li>
                                            <span style="color: #ff7000;"><i class="fas fa-check"></i></span> 
                                            <p>기존 계정을 버리고 새로운 계정으로 재가입 하려는 경우</p>
                                        </li>
                                        <li>
                                            <span style="color: #ff7000;"><i class="fas fa-check"></i></span> 
                                            <p>부모 또는 시터회원으로 회원 유형을 변경하고 싶은 경우</p> 
                                        </li>
                                        <li>
                                            <span style="color: #ff7000;"><i class="fas fa-check"></i></span> 
                                            <p>맘시터 유형을 잘못 선택한 경우 (대학생, 엄마, 선생님, 일반)</p>
                                        </li>
                                        <li>
                                            <span style="color: #ff7000;"><i class="fas fa-check"></i></span> 
                                            <p>아이디 수정 및 변경이 필요한 경우</p>
                                        </li>
                                        <li>
                                            <span style="color: #ff7000;"><i class="fas fa-check"></i></span>
                                            <p> 패스워드 수정 및 변경이 필요한 경우</p>
                                        </li>
                                        <li>
                                            <span style="color: #ff7000;"><i class="fas fa-check"></i></span>
                                            <p> 당분간 구직/ 구인 활동 계획이 없을 경우</p>
                                        </li>
                                        <li>
                                            <span style="color: #ff7000;"><i class="fas fa-check"></i></span> 
                                            <p>문자 및 카톡이 너무 많이 와서 조치가 필요한 경우.</p>
                                        </li>
                                    </ul>
                                </div>
