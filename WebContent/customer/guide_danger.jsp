...
<html lang="ko">
	<head>
		...
		<title>맘시터 > 이용가이드 > 맘시터 주의사항</title>
        ...
        <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/customer/css/guide_danger.css" />
        <!-- fontawesome(글리피콘) 적용 -->
		...
		<div class="container">
			...
			<div id="menu"></div> <!-- 헤더영역 load함수 -->
                <div class="col-xs-12 nav">
                    ...
                    <span>></span>
                    <li>
                        <a href="<%=request.getContextPath()%>/customer/guide.html">이용가이드</a>
                    </li>
                    <span>></span>
                    <li>
                        <a href="#">맘시터 주의사항</a>
                    ...
                    <div class="col-xs-12 section">
                        ...
                        <h1>맘시터 회원 모두가 절대로 하면 안 되는 행동들</h1>
                        </div>
                    </div>
                    <div class="col-xs-12 article">
                        <div class="col-xs-2 article_img">
                            <img src="<%=request.getContextPath()%>/customer/img/logo2.png" width="40" height="40">
                        </div>
