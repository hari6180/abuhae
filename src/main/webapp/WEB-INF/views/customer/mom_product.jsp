...
<html lang="ko">
	<head>
        ...
        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/assets/css/mom_product_yj.css" />
		...
		<div class="container">
			...
			<!-- header end-->
                <div class="col-xs-12 nav">
                    ...
                    <span>></span>
                    <li>
                        <a href="${pageContext.request.contextPath}/customer/notice_site.html">부모회원</a>
                    </li>
                    <span>></span>
                    <li>
                        <a href="#">부모회원 전용상품</a>
                    ...
                    <div class="col-xs-12 section">
                        ...
                        <div class="col-xs-12 section_title">
                            <a href="${pageContext.request.contextPath}/customer/guide_mom.html">[무제한 이용권] 무제한 이용권은 무엇인가요?</a>
                        </div>
                        <div class="col-xs-12 section_title">
