				...
				<div class="col-xs-12"> <!-- xs-12로 모바일 맞춤 -->				
					...
					<div class="main">						
						<div class="talk_box">
							...
							<a href="javascript:history.back();"><img src="<%=request.getContextPath()%>/page_detail/img/backPage.svg"/></a><div class="box_name"><h4>부모 후기 <span style="color: #ff7000;">999개</span></div></h4>
							</div>
