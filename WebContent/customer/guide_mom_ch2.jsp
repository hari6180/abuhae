...
<html lang="ko">
	<head>
        ...
        <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/customer/css/guide_mom_ch2.css" />
		...
		<div class="container">
			...
			<div id="menu"></div> <!-- 헤더영역 load함수 -->
                <div class="col-xs-12 nav">
                    ...
                    <span>></span>
                    <li>
                        <a href="<%=request.getContextPath()%>/customer/question_mom.html">부모회원</a>
                    </li>
                    <span>></span>
                    <li>
                        <a href="#">맘시터 찾기</a>
