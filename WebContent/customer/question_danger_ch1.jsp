...
<html lang="ko">
	<head>
        ...
        <link rel="stylesheet" type="text/css" href="/ezen-android2020-2/customer/css/question_danger_ch1.css" />
		...
		<div class="container">
			...
			<div id="menu"></div> <!-- 헤더영역 load함수 -->
                <div class="col-xs-12 nav">
                    ...
                    <span>></span>
                    <li>
                        <a href="/WebContent/customer/guide.html">이용가이드</a>
                    </li>
                    <span>></span>
                    <li>
                        <a href="#">맘시터 주의사항</a>
                    ...
                    <div class="col-xs-12 section">
                        ...
                        <div class="col-xs-12 section_title">
                            <a href="/ezen-android2020-2/customer/guide_danger.html">맘시터 회원 모두가 절대로 하면 안 되는 행동들</a>
                        </div>
