...
<html lang="ko">
	<head>
        ...
        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/assets/css/mom_activity_yj.css" />
                ...
                <div class="col-xs-12 nav">
                    ...
                    <div class="col-xs-12 section">
                        ...
                        <div class="col-xs-12 section_title">
                            <a href="${pageContext.request.contextPath}/customer/mom_activity.do">[돌봄활동] 자세한 돌봄활동이 궁금해요!</a>
                        </div>
                        <div class="col-xs-12 section_title">
