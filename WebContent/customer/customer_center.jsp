...
<html lang="ko">
	<head>
		...
		<link rel="stylesheet" type="text/css" herf="<%=request.getContextPath()%>/customer/css/flexboxgrid.css" />
		<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/customer/css/customer_center.css" />
		<!--header css-->
		<link rel="stylesheet" href="<%=request.getContextPath()%>/assets/css/index_header.css">
		<!-- fontawesome(글리피콘) 적용 -->
	...
	<div class="section_wrap"> <!-- section 전체영역 -->
			...
			<section class="section_block">
				<div class="row">
					<div class="col-xs-12">
						<ul class="block_list">
							<li class="block_item">
								<a href="<%=request.getContextPath()%>/customer/guide.html" class="block_item_link">
									<span class="block_item_title">이용가이드</span>
								</a>
							</li>
							<li class="block_item">
								<a href="<%=request.getContextPath()%>/customer/question_mom.html" class="block_item_link">
									<span class="block_item_title">부모회원</span>
									<span class="block_item_title2">자주 묻는 질문</span>
								</a>
							</li>
							<li class="block_item">
								<a href="<%=request.getContextPath()%>/customer/question_sitter.html" class="block_item_link">
									<span class="block_item_title">시터회원</span>
									<span class="block_item_title2">자주 묻는 질문</span>
								</a>
							</li>
							<li class="block_item">
								<a href="<%=request.getContextPath()%>/customer/notice_site.html" class="block_item_link">
					...
					<section class="section_activity">
						...
						<div class="activity_list">
							<a class="activity_item_parent" href="<%=request.getContextPath()%>/customer/notice_site.html">공지사항</a>
							<a class="activity_item_link" href="<%=request.getContextPath()%>/customer/notice_site_ch2.html">[공지] 아부해 서비스 서버 점검 안내</a>
						</div>
						<div class="activity_list">
		...
		$(function () {
			$("#mybutton").click(function(e) {
				$.ajax( {
					// 결과를 읽어올 URL
					url: '<%=request.getContextPath()%>/customer/hello.jsp',
