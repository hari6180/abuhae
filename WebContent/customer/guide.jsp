...
<html lang="ko">
	<head>
        ...
        <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/customer/css/guide.css" />
	...
	<body>
		<div class="container">
			...
			<%@ include file="/index_header.jsp" %>
                ...
                <div class="col-xs-12 nav">
                    <li>
                        <a href="<%=request.getContextPath()%>/customer/customer_center.html">맘시터</a>
                    </li>
                    <span>></span>
                    <li>
                        <a href="#">이용가이드</a>
                    ...
                    <div class="col-xs-12 section">
                        ...
                        <div class="col-xs-12 section_middle">
                            <h2><a href="<%=request.getContextPath()%>/customer/question_mom_ch1.html">부모회원 가이드</a></h2>
                    </div>
                    <div class="col-xs-12 section_title">
                        <a href="<%=request.getContextPath()%>/customer/guide_mom.html">[부모회원 가이드] 아부해는 어떤 서비스인가요?</a>
                    </div>
                    <div class="col-xs-12 section_title">
                    ...
                    <div class="col-xs-12 section_middle">
                        <h2><a href="<%=request.getContextPath()%>/customer/question_sitter_ch1.html">시터회원 가이드</a></h2>
                    </div>
                    <div class="col-xs-12 section_title">
                        <a href="<%=request.getContextPath()%>/customer/guide_sitter.html">[시터회원 가이드] 아부해는 어떤 서비스인가요?</a>
                    </div>
                    <div class="col-xs-12 section_title">
                    ...
                    <div class="col-xs-12 section_middle">
                        <h2><a href="<%=request.getContextPath()%>/customer/question_danger_ch1.html">맘시터 주의사항</a></h2>
                    </div>
                    <div class="col-xs-12 section_title">
                        <a href="<%=request.getContextPath()%>/customer/guide_danger.html">맘시터 회원 모두가 절대로 하면 안 되는 행동들</a>
                    </div>
                    <div class="col-xs-12 section_middle">
                        <h2><a href="<%=request.getContextPath()%>/customer/question_solution_ch1.html">해결방법</a></h2>
                    </div>
                    <div class="col-xs-12 section_title">
                        <a href="<%=request.getContextPath()%>/customer/guide_solution.html">[문제해결] 부모님께서 급여를 지급하지 않으세요.</a>
                    </div>
                    </div>
		...
		<!-- Javascript -->
		<script src="<%=request.getContextPath()%>/assets/js/jquery.min.js"></script> <!-- jquery 파일명 수정 -->		
