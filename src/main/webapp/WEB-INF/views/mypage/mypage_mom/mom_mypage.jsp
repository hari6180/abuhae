                       ...
                       <section class="group3_mpm">
                           <div class="row">
                               <div class="col-xs-12 mpm_menu">
                                   ...
                                   <a href="${pageContext.request.contextPath}/mypage/mypage_mom/update_appl.do?momno=${output.momno}">
                       ...
                       <section class="group4_mps">
                           <div class="row">
                               <div class="col-xs-12 mps_bottom">
                                   <a href="${pageContext.request.contextPath}/mypage/mypage_mom/payment_list.do?momno=${output.momno}" class="bottom_con_in bt_cash">
                                       <p>결제 내역</p>
                                       <!--백엔드 연동 필요-->
