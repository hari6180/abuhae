                                ...
                                <div class="col-xs-12 account_con_in">
                                    <div class="acc_con_one">
                                        <div class="acc_con_left col-xs-6">
                                            <p>회원 가입 정보</p>
                                            <c:choose>
                                               <c:when test="${output.ticket_type=='1' }">
                                                  <h4>무제한 이용권 (1개월)</h4>
                                               </c:when>
                                               <c:when test="${output.ticket_type=='3' }">
                                                  <h4>무제한 이용권 (3개월)</h4>
                                               </c:when>
                                               <c:when test="${output.ticket_type=='6' }">
                                                  <h4>무제한 이용권 (6개월)</h4>
                                               </c:when>
                                               <c:otherwise>
                                                  <h4>사용 중인 지원권 없음</h4>
                                ...
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body"">
                                            <form method="POST" action="${pageContext.request.contextPath}/mypage/updatePhone.do">
                            ...
                            aria-labelledby="modal_label" aria-hidden="true">
                                ...
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body"">
                                            <form method="POST" action="${pageContext.request.contextPath}/mypage/updateEmail.do">
                        ...
                        <section class="group_account_foot">
                            <div class="row">
                                <div class="col-xs-12 account_ft_in">
                                    ...
                                    <div class="line"></div>
                                    <a class="account_ft_btn" href="${pageContext.request.contextPath}/mypage/mypage_mom/agree_service.do">
                                        <p>아부해 서비스 이용 동의</p>
                                        <i class="fas fa-angle-right"></i>
                                    </a>
                                    <div class="line"></div>
