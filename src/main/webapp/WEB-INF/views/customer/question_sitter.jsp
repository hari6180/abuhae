			...
			<%@ include file="../index_header.jsp" %>
                ...
                <div class="col-xs-12 input">
	                ...
	                data-instant="true" autocomplete="off" accept-charset="UTF-8" method="GET">
	                	<input type="search" name="keyword" id="keyword" class="cus_search" value="${keyword}" placeholder="검색어를 입력하세요.">
                    	...
                    	<c:choose>
                   			...
                   			<c:otherwise>
                   				<c:forEach var="item_cate" items="${out}" varStatus="status">
                   					...
                   					<c:if test="${item_cate.cateno==3 && item_cate.subcateno==6}">
                 		...
                 		<c:choose>
                 			...
                 			<c:otherwise>
                 				<c:forEach var="item" items="${output}" varStatus="status">
                 					...
                 					<c:if test="${item.cateno==3 &&item.subcateno == 6}">
                 						<ul>
