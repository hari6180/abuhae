		...
		<div class="container">
			<div id="menu">
				<c:choose>
					...
					<c:when test="${loginType} == M">
						<%@ include file="index_header_login_mom.jsp"%>
					</c:when>
					<c:when test="${loginType} == S">
			...
			<section class="row">
				...
				<div class="col-xs-12">
					...
					<div class="guide_gorup">
						<!--부모회원 버튼-->
						<button class="guide_group_button select" data-tab="mom_guide">부모 회원</button>
						<!--시터회원 버튼-->
						<button class="guide_group_button" data-tab="sitter_guide">시터 회원</button>
					</div>
					<!--가이드 그림 -->
					<div id="guide_main" class="guide_main">
				...
				<div class="col-xs-12 faq_box">
					<h3 class="guide_title">아이를 부탁해가 <strong class="unber_bar">궁금</strong>하신가요?</h3>
					<div class="faq_group">
				...
				<div class="container">
					<div class="ft_content">
						...
						<address>
							<div class="ft_list">
								<p class="ft_list_con">
									<span class="ft_list_tl">(주)아이를부탁해</span> <br />
									서울시 서초구 서초대로77길 55 에이프로스퀘어 3층 <br />
									대표 아부해 ㅣ 사업자등록번호 : 123-56-78910 <br />
									통신판매업 신고번호 : 제 2020-서울서초-1234호 <br />
									직업제공업 신고번호 : 서울서부 제 2020 - 01호 <br />
									이 사이트는 학생들이 취업을 위한 포트폴리오 제작 사이트입니다.<br />
									추가 문의는 gina305496@gmail.com, ori080525@gmail.com로 부탁드립니다.
								</p>
							</div>
						</address>
					</div>
