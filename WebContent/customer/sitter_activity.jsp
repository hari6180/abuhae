...
<html lang="ko">
	<head>
		...
		<title>맘시터 > 시터회원 > 돌봄활동과 활동비</title>
        ...
        <link rel="stylesheet" type="text/css" href="/ezen-android2020-2/customer/css/sitter_activity.css" />
		...
		<div class="container">
			...
			<div id="menu"></div> <!-- 헤더영역 load함수 -->
                <div class="col-xs-12 nav">
                    ...
                    <span>></span>
                    <li>
                        <a href="/ezen-android2020-2/customer/question_sitter.html">시터회원</a>
                    </li>
                    <span>></span>
                    <li>
                        <a href="#">돌봄활동과 활동비</a>
                    ...
                    <div class="col-xs-12 section">
                        ...
                        <div class="col-xs-12 section_title">
                            <a href="/ezen-android2020-2/customer/sitter_activity_ch2.html">[돌봄활동] 시터는 어떤 돌봄활동을 하는 건가요?</a>
                        </div>
                        <div class="col-xs-12 section_title">
                            <a href="#">[돌봄활동] 식사는 어떻게 해결해야 하나요?</a>
                        </div>
                        <div class="col-xs-12 section_title">
                            <a href="#">[활동비] 돌봄 활동비는 어떻게 지급되나요?</a>
                        </div>
                        <div class="col-xs-12 section_title">
                            <a href="#">[활동비] 원하는 활동에 따라 시급이 차이가 나나요?</a>
                        </div>
                        <div class="col-xs-12 section_title">
                            <a href="#">[활동비] 야간근무나 휴일근무, 초과근무에 대한 수당을 요구할 수 있나요?</a>
                        </div>
                    </div>
