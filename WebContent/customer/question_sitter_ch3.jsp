...
<html lang="ko">
	<head>
        ...
        <link rel="stylesheet" type="text/css" href="/ezen-android2020-2/customer/css/question_sitter_ch3.css" />
			...
			<div id="menu"></div> <!-- 헤더영역 load함수 -->
                <div class="col-xs-12 nav">
                    ...
                    <div class="col-xs-12 section">
                        ...
                        <h1>[맘시터 인증] 건강인증뱃지를 발급 받고 싶어요.</h1>
                        </div>
                    </div>
