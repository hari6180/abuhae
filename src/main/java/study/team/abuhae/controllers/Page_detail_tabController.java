...
public class Page_detail_tabController {
	...
	// 시터 상세페이지 > 실패 후기
	@RequestMapping(value = "/page_detail/tab_faile.do", method = RequestMethod.GET)
	...
	// 시터 상세페이지 > 매칭 후기
	@RequestMapping(value = "/page_detail/tab_ok.do", method = RequestMethod.GET)
	...
	// 시터 상세페이지 > 인터뷰 후기
	@RequestMapping(value = "/page_detail/tab_interview.do", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/page_detail/tab_faile_more.do", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/page_detail/tab_ok_more.do", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/page_detail/tab_interview_more.do", method = RequestMethod.GET)
