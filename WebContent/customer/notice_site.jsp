...
<html lang="ko">
	<head>
        ...
        <link rel="stylesheet" type="text/css" href="/ezen-android2020-2/customer/css/notice_site.css" />
			...
			<div id="menu"></div> <!-- 헤더영역 load함수 -->
                <div class="col-xs-12 nav">
                    ...
                    <div class="col-xs-12 section_title">
                        <a href="/ezen-android2020-2/customer/notice_site_ch2.html">[공지] 부모회원 약속알림 설정기능 중단 안내</a>
                    </div>
                    <div class="col-xs-12 section_title">
        ...
        <script type="text/javascript">
			$(function() {
				$("#mybutton").click(function(e) {
					$.ajax( {
						// 결과를 읽어올 URL
						url: '<%=request.getContextPath()%>/customer/hello2.jsp',
