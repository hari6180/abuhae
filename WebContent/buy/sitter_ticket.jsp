...
<head>
	...
	<!-- css 적용 -->
	<link rel="stylesheet" href="<%=request.getContextPath()%>/buy/css/sitter_ticket.css">
</head>
			...
			<div class="sitter_buy_area col-xs-12">
				<div>
					...
					<button type="button" class="buy_btn_other">
					 <p class="buy_btn_style" style="color: #ff7000;">  
					   자세히 보기
					 </p>
					</button>
					...
					<div class="product_block">
						<div id="thumbnail">
							<img src="<%=request.getContextPath()%>/buy/img/safe.png" width="50" height="50" alt="보험 썸네일"/>
						</div>
						<div class="product_content">
							...
							<div class="product_desc">
								...
								(대인, 대물 자기 부담금 30만원) 맘시터를 통해 매칭되어 아이를 돌보다가 나의 과실로
								인해 발생하는 제 3자 (부모회원, 돌봤던 아이 등)의 피해(손해)를 KB손해보험에서 보장합니다.
							</div>
