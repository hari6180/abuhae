    ...
    <body>
        <div id="app">
            <div class="container">
                <div class="wrap_upd_pwd">
                                ...
                                <form action="#" id="upd_pwd_form">
                                    <div class="upd_pwd_cont"> 
                                        <div class="pwd_con_in">
                                            ...
                                            <input type="password" name="now_pw" id="now_pw" minlength="6"
                                            placeholder="현재 비밀번호를 입력하세요." style="border-bottom: 1px solid #ccc;"> 
                                        </div>
                                        <div class="pwd_con_in">
                                            <label for="new_pw">새로운 비밀번호</label> <br/>
                                            <input type="password" name="new_pw" id="new_pw" minlength="6"
                   ...
                   <!-- end content --> <!--autocomplete="false"-->
                </div>
            </div>
        </div>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                /** 임시 비밀번호 변경 기능 */
                 $("#upd_pwd_form").submit(function(e) {
                    e.preventDefault();
