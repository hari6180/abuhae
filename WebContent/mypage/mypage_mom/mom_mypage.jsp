...
<html lang="ko">
	<head>
        ...
        <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/mypage/css/mom_mypage.css"></link>
                        ...
                        <div class="row">
                            <div class="col-xs-12 mpm_title">
                                ...
                                <div class="mpm_title_cont">
                                    <!--백엔드 연동 필요-->
                                    <a href="update_password.jsp"><span class="glyphicon glyphicon-pencil"></span>비밀번호 변경</a>
                                    ㅣ
                            ...
                            <div class="col-xs-12 mpm_profile">
                                ...
                                <div class="mpm_prof_info">
                                    <div class="mpm_info_left">
                                        <img src="../img/profile.png" alt="임시 프로필사진" style="width: 52px; border-radius: 50%;">
                    ...
                    <section class="group4_mps">
                        <div class="row">
                            <div class="col-xs-12 mps_bottom">
                                ...
                                <a href="../../customer/notice_site.jsp" class="bottom_con_in">
                                    <p>공지사항</p>
                                </a>
