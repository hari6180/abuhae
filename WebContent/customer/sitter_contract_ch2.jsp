...
<html lang="ko">
	<head>
        ...
        <link rel="stylesheet" type="text/css" href="/ezen-android2020-2/customer/css/sitter_contract_ch2.css" />
			...
			<div id="menu"></div> <!-- 헤더영역 load함수 -->
                <div class="col-xs-12 nav">
                    ...
                    <div class="col-xs-12 section">
                        ...
                        <h1>[채용 및 계약] 부모님과 계약서를 작성할 수 있나요?</h1>
                        </div>
                    </div>
                    <div class="col-xs-12 article">
                        <div class="col-xs-2 article_img">
                            <img src="/ezen-android2020-2/customer/img/logo2.png" width="40" height="40">
                        </div>
