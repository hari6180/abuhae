		...
		<div class="col-xs-12"> <!-- xs-12로 모바일 맞춤 -->		
			...
			<div class="profil_photo">
			  <div class="profil_img">			  
				<img src="<%=request.getContextPath()%>/page_detail/img/chat_mom02.png" width="100%"/>
			  </div>
			...
			<div class="main">
				...
				<div class="possible_active_box">
					<div class="box_name">가능한 활동</div>
					<div class="possible_active_area">
						<div>
				...
				<div class="fixed_btn">
					<div class="fixed_btn_jim">						
						<button id="swapHeart" class="btn btn-default swap">
						    <a data-toggle="modal" href="#Modal"><span class="glyphicon glyphicon-heart-empty" style="color: #ff7000; font-size: 25px;"></span></a>
						</button>
	...
	<div id="Modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="modal-body">
					<p style="text-align: center; padding-top: 10px; font-weight: bold;">
						부모회원만 맘시터를 찜할 수 있습니다.
						'일자리 찾기'에서 나와 맞는 일자리를 찜해보세요.
					</p>
				</div>
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-default" data-dismiss="modal" id="modal_serach" onclick = "location.href = 'http://localhost:8080/<%=request.getContextPath()%>/search/job_search.jsp'">
						일자리 찾기
					</button>
				</div>
			</div>
